...
1. Let cookie-list be the set of cookies from the cookie store that
  ...
  3. The request-uri's path path-matches the cookie's path.

  4. If the cookie's secure-only-flag is true, then the request-
...
2. The user agent SHOULD sort the cookie-list in the following
  order:
  3. Cookies with longer paths are listed before cookies with
    shorter paths.

  4. Among cookies that have equal-length path fields, cookies with
