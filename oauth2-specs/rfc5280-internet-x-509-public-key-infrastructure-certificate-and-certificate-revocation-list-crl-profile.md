...
certificateRevocationList;binary>).  Omitting the  (e.g.,
...
and SHOULD include a  (e.g., <ldap://ldap.example.com/cn=CA,
dc=example,dc=com?cACertificate;binary,crossCertificatePair;binary>).
Omitting the  (e.g., <ldap:///cn=exampleCA,dc=example,dc=com?
