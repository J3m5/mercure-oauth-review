...
1. Introduction
  ...
  properties:
  2. The connection is private. Symmetric cryptography is used for
  ...
  3. The connection is reliable. Message transport includes a message
