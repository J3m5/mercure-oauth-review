...
identifiers are direct because they are provided directly by a
...
are indirect because they are automatically resolved by the
...
restricted because they can only be used for one type of service,
